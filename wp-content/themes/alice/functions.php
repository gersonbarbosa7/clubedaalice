<?php
	...
	add_action( 'init', 'publicidades', 0 );
        ...
        // Tipo de post para "Presentes"
	function presentes_boasvindas() {

		$labels = array(
			'name'                  => _x( 'Presentes de Boas Vindas', 'Post Type General Name', 'text_domain' ),
			'singular_name'         => _x( 'Presentes de Boas Vindas', 'Post Type Singular Name', 'text_domain' ),
			'menu_name'             => __( 'Presentes de Boas Vindas', 'text_domain' ),
			'name_admin_bar'        => __( 'Presentes de Boas Vindas', 'text_domain' ),
			'archives'              => __( 'Arquivos', 'text_domain' ),
			'parent_item_colon'     => __( 'Pai:', 'text_domain' ),
			'all_items'             => __( 'Todas', 'text_domain' ),
			'add_new_item'          => __( 'Nova', 'text_domain' ),
		...
		$args = array(
			'label'                 => __( 'Presentes de Boas Vindas', 'text_domain' ),
			'description'           => __( 'Presentes de Boas Vindas', 'text_domain' ),
			'labels'                => $labels,
			'supports'              => array( 'title', 'editor', 'thumbnail', ),
			'hierarchical'          => false,
			'public'                => true,
		...
		register_post_type( 'presentes_boasvindas', $args );

	}
	add_action( 'init', 'presentes_boasvindas', 0 );
        
        // Tipo de post para "Presentes"
	function planosativos() {

		$labels = array(
			'name'                  => _x( 'Planos Ativos/Inativos', 'Post Type General Name', 'text_domain' ),
			'singular_name'         => _x( 'Planos Ativos/Inativos', 'Post Type Singular Name', 'text_domain' ),
			'menu_name'             => __( 'Planos Ativos/Inativos', 'text_domain' ),
			'name_admin_bar'        => __( 'Planos Ativos/Inativos', 'text_domain' ),
			'archives'              => __( 'Arquivos', 'text_domain' ),
			'parent_item_colon'     => __( 'Pai:', 'text_domain' ),
			'all_items'             => __( 'Todas', 'text_domain' ),
			'add_new_item'          => __( 'Nova', 'text_domain' ),
		...
		$args = array(
			'label'                 => __( 'Planos Ativos/Inativos', 'text_domain' ),
			'description'           => __( 'Planos Ativos/Inativos', 'text_domain' ),
			'labels'                => $labels,
			'supports'              => array( 'title', 'editor', 'thumbnail', ),
			'hierarchical'          => false,
			'public'                => true,
		...
		register_post_type( 'planosativos', $args );

	}
	add_action( 'init', 'planosativos', 0 );
