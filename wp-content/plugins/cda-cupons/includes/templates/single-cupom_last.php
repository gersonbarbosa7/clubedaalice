...
<div class="container">
	<div class="row">
		<div class="container-cupom azul">
	    	<h1><strong><?php echo get_the_title()?></strong> | Cupom Promocional</h1>
	    </div>
		...
		<div class="container-cupom azul">
			...
			<form action="#" class="form form-dados" style="display: none" >
				...
				<div class="form-group">
					<div class="form-item">
						<input class="form-control" id="cda_cupom_nome" name="cda_cupom_nome" type="text" required>
						<label class="label-float" for="cda_cupom_nome">Nome</label>
					</div>
					<div class="form-item">
						<input class="form-control" id="cda_cupom_sobrenome" name="cda_cupom_sobrenome" type="text" required>
						<label class="label-float" for="cda_cupom_sobrenome">Sobrenome</label>
					</div>
					<div class="form-item">
						<input class="form-control" id="cda_cupom_email" name="cda_cupom_email" type="text" required>
